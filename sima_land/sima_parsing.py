...
#         rating: str = div.find_next("div", class_="e0qJYS").find_next("span", class_="jYoDfB").text
#         catalog[index] = {"name": name, "link":link, "wholesale_price":wholesale_price, "retail_price": retail_price, "rating":rating}
...
with open("data/goods.csv", "w", encoding=ENCODING) as csv_f:
    ...
    for key_num in range(1, len(catalog) + 1):
        writer.writerow(catalog[str(key_num)])  # Записываем строки
